...
| Deutsch (`de`) | 485/539 | 90% |
| Español (`es`) | 500/539 | 93% |
| Français (`fr`) | 479/539 | 89% |
| Italiano (`it`) | 479/539 | 89% |
| 日本語 (`ja`) | 500/539 | 93% |
| Русский (`ru`) | 486/539 | 90% |
| Українська (`uk`) | 486/539 | 90% |
| Polski (`pl`) | 490/539 | 91% |
| Português (Brasil) (`pt-BR`) | 500/539 | 93% |
