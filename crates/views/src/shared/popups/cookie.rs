...
/// SoundCloud hands out an OAuth token rather than a cookie, so its walkthrough names the
/// token and the place the browser keeps it.
const SOUNDCLOUD: Guide = Guide {
