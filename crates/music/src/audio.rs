...
use rodio::{DeviceSinkBuilder, MixerDeviceSink, Source, source::UniformSourceIterator};
...
impl Output {
    ...
    pub fn open(chain: Chain) -> Result<Self> {
        ...
        let uniform = UniformSourceIterator::new(equalized, channels, rate);
